...
//	}
	...
	@Before("execution(* com.mzd.multipledatasources.service..*.get*(..))")
	public void setDataSourceTqr(){
		System.out.println("from tqr");
		DataSourceType.setDataBaseType(DataSourceType.DataBaseType.TEST01);
	}
	@Before("execution(* com.mzd.multipledatasources.service..*.insert*(..))")
	public void setDataSourceTqrAdd(){
		System.out.println("insert tqr");
